...
PYR_HH["secs"]["dend"]["geom"] = {
    "diam": 5.0,
    "L": 150.0,
    "Ra": 150.0,
    "cm": 1,
}  # dend geometry
PYR_HH["secs"]["dend"]["topol"] = {
    "parentSec": "soma",
    "parentX": 1.0,
    "childX": 0,
}  # dend topology
...
netParams.stimTargetParams["bkg->PYR"] = {
    "source": "bkg",
    "conds": {"cellType": ["PYR_Izhi", "PYR_HH"]},
    "weight": 0.01,
    "delay": 5,
    "synMech": "exc",
}
...
simConfig.filename = "../results/Tutorial04/tut4"  # Set file output name
...
# See also:
# * http://doc.netpyne.org/user_documentation.html#importing-cells
